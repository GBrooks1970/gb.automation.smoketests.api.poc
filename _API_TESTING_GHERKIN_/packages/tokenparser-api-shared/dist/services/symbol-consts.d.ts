export declare class SymbolsOBS {
...
export declare class SymbolsDT {
...
export declare class SymbolsDate {
    static readonly TODAY = "[TODAY]";
    static readonly TOMORROW = "[TOMORROW]";
    static readonly YESTERDAY = "[YESTERDAY]";
    static readonly BracketedTokenRegex: RegExp;
    static readonly TokenDate: {
        FullRegex: RegExp;
        RangeRegex: RegExp;
    };
    static readonly TokenDateInnerSectionRegex: RegExp;
}
export declare class SymbolsDS {
    ...
    static readonly DynamicStringRegex: RegExp;
}
