...
class TokenDynamicStringParser {
    ...
    static ALPHA_CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    static NUMERIC_CHARS = "0123456789";
    static PUNCTUATION_CHARS = ".,!?;:";
    static SPECIAL_CHARS = "!@#$%^&*()_+[]{}|;:,.<>?";
    static errorInvalidStringTokenFormat = "Invalid string token format ";
